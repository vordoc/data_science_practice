...
объектов Series. 
Также создать DataFrame можно, загрузив данные из базы данных, файла CSV, запроса API 
...
(в метод передаётся либо объект path - путь до нужного JSON-файла, либо URL HTTP API, 
